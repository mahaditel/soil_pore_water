...
isu.plot + 
  ...
  theme(strip.text = element_text(size = 26),  # Keep the text visible and customized if needed
  ...
  theme(axis.title.y = element_blank(), 
        ...
        strip.background = element_blank()    # Ensure consistency in the WIU plot
  ) +
  plot_layout(ncol = 2, guides = "collect") +
  NULL

ggsave(final.plot, file="figures/fianl_nitrate.pdf", units = "in", 
       width = 16, height = 6)
